 ...
 * Restaurant). Replaced by official award assets when they arrive.
 */
const CRESTS = [
  <path
    key="michelin-star"
    ...
    <div className="mt-10 mb-2 flex flex-col gap-3.5">
      {awards.map((award, index) => (
        <Reveal
          ...
          key={award.title}
          delay={160 + index * 80}
          className="border-champagne/[0.42] from-champagne/[0.18] to-champagne/[0.04] grid grid-cols-[64px_1fr] items-center gap-[22px] border bg-linear-120 to-72% px-[22px] py-[18px] shadow-[inset_0_0_40px_rgba(0,0,0,0.25)] max-[560px]:grid-cols-[46px_1fr] max-[560px]:gap-4 max-[560px]:px-[18px] max-[560px]:py-4"
        >
